...
public class PhotoSelectBaseActivity extends BaseActivity{
    /** 图片选择
     * @param selectmode  选择模式 多选 or 单选 PictureConfig.MULTIPLE、SINGLE
     * @param maxselect   最大多少张图片
     * @param selectList  保存实体类  LocalMedia
     * @param resultcode  ActivityResultCode
     */
    public void SeletPicture(int selectmode, int maxselect, List<LocalMedia> selectList, int resultcode){
        PictureSelector.create(me)
                ...
                .selectionMode(selectmode)// 多选 or 单选( 多选)
